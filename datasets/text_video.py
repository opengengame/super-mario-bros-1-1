...
class Dataset(torch_dataset.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # 3: run jump
        # 4: ack
        grid_size = [frames.shape[1], frames.shape[2] // self.latent_scale, frames.shape[3] // self.latent_scale, 5]
